...
indices) came out positive in the first two years and slightly positive in the
latest year (profit factor 1.05: Nifty and Sensex made money, Bank Nifty lost,
and all of that year's profit came on expiry days) —
on modelled prices rather than real fills, and with drawdowns of up to ₹4.81 lakh
