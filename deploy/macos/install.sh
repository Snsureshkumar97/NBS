...
#   com.nbs.optionrecorder - saves the day's real option prices after the close
#
...
UID_N=$(id -u)
HERE=${0:A:h}
for L in com.nbs.tailscaled com.nbs.signaltool com.nbs.morningcheck com.nbs.optionrecorder; do
