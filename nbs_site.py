 ...
 <section>
  ...
  <ul>
   ...
   <li><b>Two controls meant to cut the drawdown.</b> A circuit breaker that paper-traded
    ...
    &#8377;4,80,832 to &#8377;1,80,995 &mdash; measured against the rules as they stood
    that morning, which still waited out the opening range &mdash; but in the first two years it sat out
   ...
   <li><b>Trading from 09:15, and a lower reward floor.</b> Two changes meant to
    produce more trades. Dropping the wait for the 09:15&ndash;09:45 opening range
    made &#8377;55,233 less in the first two years and &#8377;63,905 more in the
    held-out year, with a drawdown &#8377;54,804 shallower &mdash; mixed, and worth
    only 138 extra trades out of 6,158, because the gap between entries and the
    daily cap refill the day anyway. <b>It is in use from 16 Sep 2026</b>, chosen
    knowing it fails the &ldquo;better in both periods&rdquo; test. Asking a target of
    only 0.7&times; the stop instead of 1&times; did add trades &mdash; 404 of them
